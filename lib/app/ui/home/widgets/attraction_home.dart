...
Widget _buildList(
    BuildContext context, AttractionController attractionController) {
  return SizedBox(
    height: 260,
    child: ListView(
      scrollDirection: Axis.horizontal,
      children: List<Attraction>.from(attractionController.attractionsList)
          .map((att) => GestureDetector(
        onTap: () {
          Navigator.push(
              context,
              MaterialPageRoute(
